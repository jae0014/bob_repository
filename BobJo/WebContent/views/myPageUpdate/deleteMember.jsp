	...
	<div class="shopping-info" >
		<div class="area info01" style="width:100%;">
			<p style="font-size:20px">
				정말로 탈퇴하시겠습니까?<br>
				<p style="color:rgb(170,57,57); font-size:25px" >회원탈퇴전 다음 사항을 꼭 숙지하시기 바랍니다.</p> <br>
				
				<ul>
				<li> 진행중인 구매내역이 있을 경우 회원 탈퇴가 불가능하며, 거래 완료 후 탈퇴 하실 수 있습니다.

				</li>
				<li>
				 회원탈퇴시 적립된 적립금은 모두 즉시 소멸되며 재가입시에도 재적립 되지 않습니다.
				</li>
				</ul>
			</p>
		</div>
...
<div class="secession-check-member">
			...
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="id" validation="true" value='' title="아이디" style="width:200px;" readonly>
					</td>
				</tr>
				<tr>
					<th scope="col">
		...
		<div class='btn-area'>
			...
			<a href="myProfile.jsp" class='sub_k_buttom buttom_m'>취소</a>
		</div>
