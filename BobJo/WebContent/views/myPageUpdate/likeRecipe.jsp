...
<h2>좋아요 레시피 보기</h2>
<p class="desc">내가 좋아요를 누른 레시피를 볼 수 있습니다.</p>
</div>
            ...
            <div class="card-body" >
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  ...
                  <div class="like" id="like1"><img width =20px, height =20px, src="<%=request.getContextPath() %>/resources/images/fulllike.png"></div>
