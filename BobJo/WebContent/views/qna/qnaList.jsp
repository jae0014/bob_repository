<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import = "java.util.ArrayList, qna.model.vo.Qna, common.vo.* ,java.text.SimpleDateFormat"%>
                                    ...
                                    <nav aria-label="..." style="display: inline-block;">
										...
										<% for(int p = startPage; p <= endPage; p++){ %>
											...
											<li class="page-item active">
                                                ...
                                                href='<%=request.getContextPath() %>/qna.li?currentPage=<%=p%>'
                                                ><%= p%></a>
                                            </li>
											<% } else
											{ %>
											<li class="page-item ">
                                                <a class="page-link pageList" 
                                                href='<%=request.getContextPath() %>/qna.li?currentPage=<%=p%>' ><%= p%></a>
                                            </li>											
                                            <% } %>
											<% } %>
											<!--  페이지 목록 끝 -->
                                            ...
                                            <% } else { %>
                                             <li class="page-item">
                                                    <a class="page-link "
                                                    href='<%=request.getContextPath() %>/qna.li?currentPage=<%= currentPage +5 %>' >Next</a>
                                            </li>
